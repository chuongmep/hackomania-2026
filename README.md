...
### Event & Organization
- **[Hackomania 2026](https://hackomania.geekshacking.com/)** - For hosting this incredible 24-hour hackathon
- **Judges and Mentors** - For valuable feedback and guidance throughout the event
- **Event Organizers** - For creating an inspiring environment for innovation

### Our Team (HackIT Team 24h)
**24 hours of coding, learning, and building together! 🚀**

- **Chuong** (chuongpqvn@gmail.com) - Full-stack development, API integration
- **Tuan Le** (leducanhtuan3006@gmail.com) - Frontend development, UI/UX
- **Samuel** (SamLee347@hotmail.com) - Backend architecture, database design
- **Yan** (chooyanprogramming@gmail.com) - System design, deployment

### Technology & Tools
- **Vercel** - Seamless deployment and hosting platform
- **Google Cloud Platform** - Reliable backend infrastructure
- **Azure Cognitive Services** - Speech-to-text transcription
- **OpenStreetMap & Leaflet** - Beautiful and free mapping solutions
- **React & FastAPI Communities** - Amazing documentation and support

### Special Thanks
- **Emergency Response Teams** - Real-world heroes who inspired this project
- **Our Families & Friends** - For support and encouragement during the hackathon
- **Coffee Suppliers** - For keeping us caffeinated through the night ☕
- **Future Users** - Who will benefit from this system in real emergencies 🚑

### Resources & Inspiration
- [Presentation Slides](https://docs.google.com/presentation/d/1t6mOE3n6bdeLQVjkHmwJMtGJtA2nQcDHQ6C2UskmWic/edit?usp=sharing)
- [System Architecture Diagram](https://lucid.app/lucidchart/1366c763-caef-450c-9534-fe6c66a39e98/edit?view_items=IokUlqxaL2PuV1AHdFKDwjptYKA%3D&page=0_0&invitationId=inv_f80f99aa-ecd0-4dfb-a001-e668f696a970)

---

**Built with ❤️ during Hackomania 2026 Hackathon**  
*Making emergency response faster, smarter, and more accessible for everyone.*
